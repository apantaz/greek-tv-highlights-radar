...
with eligible_broadcasts as (
    select
        ...
        broadcasts.tmdb_id,
        broadcasts.media_type,
        broadcasts.match_confidence,
        broadcasts.source,
        broadcasts.channel,
        ...
        programmes.runtime_minutes,
        programmes.metadata_retrieved_at,
        programmes.imdb_id,
        programmes.poster_path,
...
select
    ...
    row_number() over (
        partition by source, schedule_date
        order by
            highlight_score desc,
            quality_score desc,
            confidence_score desc,
